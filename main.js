...
class LanguageToggle {
    ...
    toggleLanguage() {
        if (this.languageToggle.textContent === "Taal") {
            ...
            this.popupdescription2.textContent = "I set out to replicate Udemy's primary web page, a well-known online course platform. Utilizing HTML, SCSS, and JavaScript, I enhanced the appearance and functionality. This solo project enriched my interactive skills, deepened my knowledge of HTML and SCSS, and was completed in four weeks.";
            this.popupdescription3.textContent = "Inspired by my favorite color website, Colorhunt, I decided to create my own color picker. Using HTML, SCSS, and JavaScript, I've crafted a useful tool that simplifies the process of selecting and experimenting with colors. This project not only honed my web development skills but also allowed me to explore my artistic side. I delved into JavaScript rendering and completed this project in under one and a half weeks, thanks to the valuable learning experiences it provided. Importantly, I accomplished this project entirely on my own.";
            ...
            this.popupdescription2.textContent = "Ik ging aan de slag om de webpagina van Udemy, een bekend online cursusplatform, na te bootsen. Met behulp van HTML, SCSS en JavaScript heb ik zowel het uiterlijk als de functionaliteit verbeterd. Dit soloproject heeft mijn vaardigheden versterkt, mijn kennis van HTML en SCSS verdiept en was in vier weken voltooid."
